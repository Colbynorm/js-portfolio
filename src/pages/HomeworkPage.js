    ...
    return(
        ...
        <div>
          <p>{props.title}</p>
            ...
            <a className="nav-link" id="homework" href="https://github.com/Colbynorm/note-taker">
              Link To Code
            </a>
        </div>
        ...
        <div>
          ...
          <a className="nav-link" id="homework" href={props.link}>
            ...
            <a className="nav-link" id="homework" href="https://colbynorm.github.io/weather-dashboard/"
            >Live Link To App
            </a>
        </div>
